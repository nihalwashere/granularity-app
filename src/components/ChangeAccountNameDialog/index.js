...
const ChangeAccountNameDialog = (props) => {
  ...
  return (
    <div>
      <Dialog
        ...
        maxWidth="sm"
      >
        <DialogTitle onClose={handleClose}>Change account name</DialogTitle>
...
ChangeAccountNameDialog.propTypes = {
...
export default ChangeAccountNameDialog;
